import{a as u,i as a,b as p,d as $,e as g}from"./assets/scrollup-90be812b.js";import{a as h,S as d,P as A}from"./assets/vendor-f5f845be.js";const w="https://food-boutique.b.goit.study/api/products";async function q(){try{return(await h.get(`${w}/categories`)).data}catch(t){throw console.error("Error fetching categories:",t),t}}function T({page:t,limit:e,keyword:o,category:n,byABC:s,byPrice:c,byPopularity:i}){const r={page:t,limit:e,...o&&{keyword:o},...n&&{category:n},...s&&{byABC:s},...c&&{byPrice:c},...i&&{byPopularity:i}};return h.get(`${w}`,{params:r})}async function E(t){try{return(await h.get(`${w}/${t}`)).data}catch(e){throw console.error("Error fetching product by id:",e),e}}const _=document.querySelector(".loader"),B=document.getElementById("main-content");function k(){const t=document.getElementById("filters-section");t&&t.scrollIntoView({behavior:"smooth"})}function x(){_.removeAttribute("hidden"),B.style.filter="blur(5px) grayscale(1)"}function I(){_.setAttribute("hidden",""),B.style.filter="none",k()}document.addEventListener("DOMContentLoaded",function(){const t=document.getElementById("discount-products");document.getElementById("pagination");async function e(s){try{const i=(await h.get("https://food-boutique.b.goit.study/api/products/discount?page=${page}&limit=${itemsPerPage}`")).data;t.innerHTML="",i.forEach(r=>{const l=o(r);t.innerHTML+=l}),i.forEach(r=>{document.querySelector(`[data-product-id="${r._id}"]`).addEventListener("click",()=>D(r._id,i))}),u(i,".cart-btn-list-discount",a),p(i,".cart-btn-list-discount",a)}catch(c){console.error("Error fetching discount products:",c)}}e();function o(s){const c=s.name,i=12,r=window.innerWidth,l=c.length>i&&r>=1440,P=n(c,i);return`
      ...
      `,e.appendChild(n)}),t.forEach(o=>{document.querySelector(`[data-product-id="${o._id}"]`).addEventListener("click",()=>U(o._id,t))}),u(t,".popular-cart-btn",a),p(t,".popular-cart-btn",a)}H().then(t=>{M(t)}).catch(t=>{console.error("Error:",t)});async function U(t,e){try{const o=await E(t);R(o,e)}catch(o){console.error("Error fetching product details:",o)}}function R(t,e){d.fire({html:`
        <div class="modal-product-container">
          <div class="modal-image-container">
            <img src="${t.img}" alt="${t.name}">
          </div>
      ...
      `,showConfirmButton:!1,customClass:{container:"custom-swal"}}),p(e,".modal-add-to-cart-btn",a),u(e,".modal-add-to-cart-btn",a),document.querySelector(".custom-close-icon").addEventListener("click",()=>{d.close()})}const f=document.getElementById("products-list-container"),L=document.querySelector(".no-results-container");let C;window.addEventListener("resize",z);function z(){let t;window.innerWidth>=1440?t=9:window.innerWidth>=768?t=8:t=6,$().limit!==t&&(g("page",1),v())}function j(){const t=document.getElementById("tui-pagination-container");t&&t.remove();const e=document.createElement("div");e.id="tui-pagination-container",e.className="tui-pagination",f.after(e)}async function v(){z();const t=$();let e=t.page||1,o=t.limit||6;x();try{const n=await T(t),{perPage:s,totalPages:c,results:i}=n.data,r=s*c;if(i.length===0){L.classList.remove("visually-hidden"),f.innerHTML="";return}f.innerHTML=Y(i),L.classList.add("visually-hidden"),i.forEach(l=>{document.querySelector(`[data-product-id="${l._id}"]`).addEventListener("click",()=>N(l._id,i))}),O(r,e,o),p(i,".cart-btn-list",a),u(i,".cart-btn-list",a)}catch(n){console.error("Error fetching products",n)}finally{I()}}function O(t,e,o){j();const n=document.getElementById("tui-pagination-container");if(t>o){const s=window.innerWidth<768?2:4;C=new A(n,{totalItems:t,itemsPerPage:o,visiblePages:s,centerAlign:!0,page:e}),C.on("beforeMove",c=>{g("page",c.page),v()})}}function Y(t){return`<ul class="card-container-list">${t.map(e=>{const o=e.category.split("_").join(" ");return`
        ...
        </li>`}).join("")}</ul>`}async function N(t,e){try{x();const o=await E(t);V(o,e)}catch(o){console.error("Error fetching product details:",o)}finally{I()}}function V(t,e){d.fire({html:`
      <div class="modal-product-container">
        <div class="modal-image-container">
          <img src="${t.img}" alt="${t.name}">
        </div>
    ...
    `,showConfirmButton:!1,customClass:{container:"custom-swal"}}),p(e,".modal-add-to-cart-btn",a),u(e,".modal-add-to-cart-btn",a),document.querySelector(".custom-close-icon").addEventListener("click",()=>{d.close()})}async function m(t,e){g(t,e),g("page",1),await v()}async function G(){try{const t=await q(),e=document.getElementById("category-select");t.forEach(o=>{const n=document.createElement("option");n.value=o,n.textContent=o.replace(/_/g," "),e.appendChild(n)})}catch(t){console.error("Error fetching categories:",t)}}async function J(){const t=$();if(t.keyword&&(document.getElementById("search-bar-id").value=t.keyword),await G(),t.category&&(document.getElementById("category-select").value=t.category),t.byABC||t.byPrice||t.byPopularity){const e=document.getElementById("sorting-select");e.value=t.byABC?"byABC":t.byPrice?"byPrice":"byPopularity"}await v()}function K(){const t=document.getElementById("search-form"),e=document.getElementById("category-select"),o=document.getElementById("sorting-select");t.addEventListener("submit",async n=>{n.preventDefault();const s=n.target.elements["item-search-value"].value.trim();m("keyword",s||null)}),e.addEventListener("change",n=>{m("category",n.target.value!=="Show all"?n.target.value:null)}),o.addEventListener("change",n=>{const s=n.target.value;m("byABC",s==="byABC"),m("byPrice",s==="byPrice"),m("byPopularity",s==="byPopularity")})}document.addEventListener("DOMContentLoaded",()=>{J(),K()});window.onscroll=()=>b();window.addEventListener("scroll",S(b,250)),window.addEventListener("resize",S(b,250));async function b(){const t=document.querySelector("body"),e=document.body.offsetHeight,o=window.innerHeight,n=window.scrollY,s=e-o/4;n+o>s?t.classList.add("body--no-transparency"):t.classList.remove("body--no-transparency")}function S(t,e){let o=null;return function(...s){o||(o=setTimeout(()=>{t(...s),clearTimeout(o),o=null},e))}}
