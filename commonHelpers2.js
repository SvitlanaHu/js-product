import{a as u,i as a,b as p,d as $,e as h}from"./assets/scrollup-14c59fdf.js";import{a as g,S as l,P as z}from"./assets/vendor-f5f845be.js";const w="https://food-boutique.b.goit.study/api/products";async function A(){try{return(await g.get(`${w}/categories`)).data}catch(t){throw console.error("Error fetching categories:",t),t}}function q({page:t,limit:e,keyword:o,category:s,byABC:n,byPrice:c,byPopularity:i}){const r={page:t,limit:e,...o&&{keyword:o},...s&&{category:s},...n&&{byABC:n},...c&&{byPrice:c},...i&&{byPopularity:i}};return g.get(`${w}`,{params:r})}async function E(t){try{return(await g.get(`${w}/${t}`)).data}catch(e){throw console.error("Error fetching product by id:",e),e}}const B=document.querySelector(".loader"),_=document.getElementById("main-content");function T(){const t=document.getElementById("filters-section");t&&t.scrollIntoView({behavior:"smooth"})}function x(){B.removeAttribute("hidden"),_.style.filter="blur(5px) grayscale(1)"}function I(){B.setAttribute("hidden",""),_.style.filter="none",T()}document.addEventListener("DOMContentLoaded",function(){const t=document.getElementById("discount-products");document.getElementById("pagination");async function e(n){try{const i=(await g.get("https://food-boutique.b.goit.study/api/products/discount?page=${page}&limit=${itemsPerPage}`")).data;t.innerHTML="",i.forEach(r=>{const d=o(r);t.innerHTML+=d}),i.forEach(r=>{document.querySelector(`[data-product-id="${r._id}"]`).addEventListener("click",()=>k(r._id,i))}),u(i,".cart-btn-list-discount",a),p(i,".cart-btn-list-discount",a)}catch(c){console.error("Error fetching discount products:",c)}}e();function o(n){const c=n.name,i=12,r=window.innerWidth,d=c.length>i&&r>=1440,P=s(c,i);return`
      ...
      `,showConfirmButton:!1,customClass:{container:"custom-swal"}}),p(e,".modal-add-to-cart-btn",a),u(e,".modal-add-to-cart-btn",a),document.querySelector(".custom-close-icon").addEventListener("click",()=>{l.close()})}const f=document.getElementById("products-list-container"),L=document.querySelector(".no-results-container");let C;window.addEventListener("resize",R);function R(){let t;window.innerWidth>=1440?t=9:window.innerWidth>=768?t=8:t=6,$().limit!==t&&(h("page",1),h("limit",t),v())}function j(){const t=document.getElementById("tui-pagination-container");t&&t.remove();const e=document.createElement("div");e.id="tui-pagination-container",e.className="tui-pagination",f.after(e)}async function v(){const t=$();let e=t.page||1,o=t.limit||6;x();try{const s=await q(t),{perPage:n,totalPages:c,results:i}=s.data,r=n*c;if(i.length===0){L.classList.remove("visually-hidden"),f.innerHTML="",document.getElementById("tui-pagination-container").classList.add("visually-hidden");return}f.innerHTML=Y(i),L.classList.add("visually-hidden"),i.forEach(d=>{document.querySelector(`[data-product-id="${d._id}"]`).addEventListener("click",()=>N(d._id,i))}),O(r,e,o),p(i,".cart-btn-list",a),u(i,".cart-btn-list",a)}catch(s){console.error("Error fetching products",s)}finally{I()}}function O(t,e,o){j();const s=document.getElementById("tui-pagination-container");if(t>o){const n=window.innerWidth<768?2:4;C=new z(s,{totalItems:t,itemsPerPage:o,visiblePages:n,centerAlign:!0,page:e}),C.on("beforeMove",c=>{h("page",c.page),v()})}else s.classList.add("visually-hidden")}function Y(t){return`<ul class="card-container-list">${t.map(e=>{const o=e.category.split("_").join(" ");return`
        ...
        </li>`}).join("")}</ul>`}async function N(t,e){try{x();const o=await E(t);V(o,e)}catch(o){console.error("Error fetching product details:",o)}finally{I()}}function V(t,e){l.fire({html:`
      <div class="modal-product-container">
        <div class="modal-image-container">
          <img src="${t.img}" alt="${t.name}">
        </div>
