import{g as c,s as m,c as g}from"./assets/local-storage-9fe54653.js";const l=document.querySelector(".js-cart-list"),b=document.querySelector(".js-delete-all-btn"),a=document.querySelector(".all-content-wrap"),h=document.querySelector(".js-number-of-products"),v=document.querySelector(".js-cart-amount");f();o();function f(){const t=c();a.classList.add("is-visible-main-content"),j(t),l.addEventListener("click",C)}function C(t){if(!t.target.classList.contains("js-delete-product-btn"))return;const e=t.target.closest(".js-cart-item"),s=e.dataset.id,r=c().filter(({_id:i})=>s!==i);m(r),e.style.display="none",o(),L(),d()}function L(){c().length||a.classList.replace("is-visible-main-content","is-hidden-main-content")}function j(t){if(!t.length){a.classList.add("is-hidden-main-content");return}const e=t.map(({_id:s,name:n,img:r,category:i,price:u,size:p})=>`<li class="cart-item js-cart-item" data-id = ${s}>
