import{a as d,P as u}from"./assets/vendor-b592f4c5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function s(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerpolicy&&(o.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?o.credentials="include":e.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(e){if(e.ep)return;e.ep=!0;const o=s(e);fetch(e.href,o)}})();const p="https://food-boutique.b.goit.study/api/products";function f(i,t){return d.get(`${p}`,{params:{page:i,limit:t}})}const g="/js-product/assets/symbol-defs-bacee5fb.svg",h=document.querySelector(".main-container");async function m(){let i=1,t;window.innerWidth>=1440?t=9:window.innerWidth>=768?t=8:t=6;try{const{data:s}=await f(i,t);console.log(s);const{results:n}=s;console.log(n),l(n),h.innerHTML+=l(n)}catch(s){console.error("Error fetching products",s)}}m();function l(i){return`<ul class="card-container-list">${i.map(t=>{const s=t.category.split("_").join(" ");return`
                        ...
                        <div class="price-and-btn-list">
                            ...
                            <button class='cart-btn-list' type="button">          
                                <svg class="list-cart-svg-list" width="18" height="18">
                                    <use href="${g}#icon-heroicons-solid_shopping-cart-18x18">
                                    </use>
                                </svg>
                            </button>
                        </div>
