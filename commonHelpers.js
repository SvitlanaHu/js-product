import{g as n,s as m,i as b,c as g}from"./assets/local-storage-6f64b94b.js";const l=document.querySelector(".js-cart-list"),h=document.querySelector(".js-delete-all-btn"),a=document.querySelector(".all-content-wrap"),f=document.querySelector(".js-number-of-products"),v=document.querySelector(".js-cart-amount");document.querySelector(".order-form");C();o();function C(){const t=n();a.classList.add("is-visible-main-content"),S(t),l.addEventListener("click",L)}function L(t){if(!t.target.classList.contains("js-delete-product-btn"))return;const e=t.target.closest(".js-cart-item"),s=e.dataset.id,r=n().filter(({_id:i})=>s!==i);m(r),e.style.display="none",o(),j(),d()}function j(){n().length||a.classList.replace("is-visible-main-content","is-hidden-main-content")}function S(t){if(!t.length){a.classList.add("is-hidden-main-content");return}const e=t.map(({_id:s,name:c,img:r,category:i,price:u,size:p})=>`<li class="cart-item js-cart-item" data-id = ${s}>
